    ...
    public class ProcedureCheckVersion : ProcedureBase
    {
        ...
        protected override void OnEnter(ProcedureOwner procedureOwner)
        {
            ...
            GameEntry.WebRequest.AddWebRequest(
                GameFramework.Utility.Text.Format(GameEntry.BuiltinData.BuildInfo.CheckVersionUrl, GetPlatformPath()),
                this);
        }
        ...
        private void OnWebRequestSuccess(object sender, GameEventArgs e)
        {
            ...
            // 设置资源更新下载地址
            GameEntry.Resource.UpdatePrefixUri =
                GameFramework.Utility.Path.GetRegularPath(m_VersionInfo.UpdatePrefixUri);
            ...
            switch (Application.platform)
            {
                ...
                default:
                    throw new System.NotSupportedException(
                        GameFramework.Utility.Text.Format("Platform '{0}' is not supported.", Application.platform));
            }
        }
    }
}
